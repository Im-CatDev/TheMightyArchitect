	...
	public void handle(Supplier<NetworkEvent.Context> context) {
		context.get()
			.enqueueWork(() -> {
				...
				sign.setMessage(0, Lang.text(text1).color(0xD7C2D7)
					.component());
				sign.setMessage(1, Lang.text(text2).color(0xaaaaaa)
					.component());
				sign.setMessage(2, Lang.text(text3).color(0xdddddd)
					.component());
				sign.setMessage(3, Lang.text(text4).color(0xdddddd)
					.component());
				sign.setChanged();
